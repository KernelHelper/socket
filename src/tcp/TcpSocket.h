...
void Tcp_SetSockAddrInf(const _TCHAR * ptServerAddr, int nServerPort, struct sockaddr_in & serverAddrIn);
...
int Tcp_Read(SOCKET s, const char * data, int size);

int Tcp_Write(SOCKET s, char * data, int size);
